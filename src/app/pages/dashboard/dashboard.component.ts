...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  loadLineChart(chartType) {
    ...
    chart = this.createSeriesLine(chart, "#21AFDD", "cases", "cas");
    chart = this.createSeriesLine(chart, "#10c469", "recoveries","guéris");
    chart = this.createSeriesLine(chart, "#ff5b5b", "deaths","morts");
  ...
  createSeriesLine(chart, color, type, frenchtype) {
    let name = frenchtype.charAt(0).toUpperCase() + frenchtype.slice(1);
